<div class="wrap">
	<div class="extension_header">
		...
		<p><?php printf(__('IgnitionDeck Modules allow you to upgrade, modify, and customize the default IgnitionDeck installation in order to achieve additional features sets. %sUpgrade to Enterprise%s to full unlock all available modules', 'idf'), '<a href="https://ignitiondeck.com/id/ignitiondeck-pricing/?utm_source=idf&utm_medium=link&utm_campaign=freemium">', '</a>'); ?>.
		</p>
