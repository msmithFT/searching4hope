...
Plugin URI: https://wpcodefactory.com/item/crowdfunding-woocommerce-wordpress-plugin/
...
//		wp_enqueue_style( 'jquery-ui-css',         '//ajax.googleapis.com/ajax/libs/jqueryui/1.8.2/themes/smoothness/jquery-ui.css', array(),           $this->version );
	...
	function action_links( $links ) {
		...
		$unlock_all = apply_filters( 'alg_crowdfunding_option', array(
			'<a href="' . esc_url( 'https://wpcodefactory.com/item/crowdfunding-woocommerce-wordpress-plugin/' ) . '">' . __( 'Unlock all', 'crowdfunding-for-woocommerce' ) . '</a>',
		), 'settings_array' );
