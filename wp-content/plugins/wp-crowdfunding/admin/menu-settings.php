...
function neo_crowdfunding_go_premium(){
    ...
    $html .= '<li class="dashicons-before dashicons-yes"><span>Wallet Deposit</span> - Donate to campaigns using your wallet balance.</li>';
    $html .= '<li class="dashicons-before dashicons-yes"><span>Embedded Donate Button</span> - Set donate button to any where via shortcode to quickly checkout to a campaigns.</li>';
    $html .= '<li class="dashicons-before dashicons-yes"><span>Popular Campaigns</span> - Pupular campaigns shortcode to place popular campaigns module.</li>';
