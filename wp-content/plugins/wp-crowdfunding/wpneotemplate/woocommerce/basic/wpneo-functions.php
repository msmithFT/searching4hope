...
function wpneo_bio_campaign_action(){
	...
	if( $author ){
		...
		$html .= '<div class="wpneo-profile-campaigns">'.wpneo_crowdfunding_author_all_campaigns()->post_count.__( " Campaigns" , "wp-crowdfunding" ).' | '. wpneo_loved_campaign_count().__( " Loved campaigns" , "wp-crowdfunding" ).'</div>';
		$html .= '</div>';
